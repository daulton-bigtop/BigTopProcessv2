...
const FULL_TEMPLATE = {
  ...
  steps: [
    ...
    },
    {
      ...
      label: "Preassigned production slot already set?",
      lane: "Project Management",
      type: "decision",
      next: [
    ...
    },
    {
      ...
      label: "Confirm preassigned production slot",
      lane: "Project Management",
      type: "milestone",
...
const els = {
  ...
  preassignSlot: document.getElementById("preassignSlot"),
...
function readInputs() {
  ...
  return {
    ...
    preassignSlot: els.preassignSlot.value === "yes"
  };
}
...
function buildScenario(input) {
  ...
  if (input.preassignSlot) {
    productionSlotStep = add("preassigned_production_slot", {
